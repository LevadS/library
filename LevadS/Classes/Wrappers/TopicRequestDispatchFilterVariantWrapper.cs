...
internal class TopicRequestDispatchFilterVariantWrapper<TRequest, TResponse>(object filter)
    : BaseTopicFilterVariantWrapper(filter), ITopicRequestDispatchFilter<TRequest, TResponse>
{
